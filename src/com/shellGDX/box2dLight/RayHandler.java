...
public class RayHandler implements Disposable
{
   ...
   * for culling and rendering. Remember to update it if camera changes. This
   * will work with rotated cameras.
   * 
   * <p>
   ...
   * 
   * <p>
   * If any problems detected use the
   ...
   *          combined matrix position
   * @param viewPortWidth
   *          NOTE!! use actual size, remember to multiple with zoom value if
   *          pulled from OrthoCamera
   ...
   *          color whose RGB components specify the shadows coloring and alpha
