...
public abstract class Light2D implements Disposable
{
  ...
  /**
   * vertical starting position of light in world coordinates. directional light
   * return 0
   */
  /**
   * @return posY
  ...
  /**
   * return is this light static. Static light do not get any automatic updates
   * but setting any parameters will update it. Static lights are usefull for
   * lights that you want to collide with static geometry but ignore all the
   * dynamic objects.
   * 
   * @return
   */
   ...
   * automatic updates but setting any parameters will update it. Static lights
   * are usefull for lights that you want to collide with static geometry but
   * ignore all the dynamic objects. Reduce cpu burden of light about 90%.
   * 
   * @param staticLight
   */
