...
abstract public class TemporalAction extends Action3D
{
   ...
   * to query the {@link #model model's} starting state.
   */
   ...
   * 
   * @param percent
   *          The percentage of completion for this action, growing from 0 to 1
   *          over the duration. If {@link #setReverse(boolean) reversed}, this
   *          will shrink from 1 to 0.
   */
